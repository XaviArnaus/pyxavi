...
class Dictionary:
    ...
    def get(self, param_name: str = "", default_value: any = None) -> any:
        ...
        if self._needs_resolving(param_name=param_name):
            return self._get_horizontally(
                param_name=param_name, default_value=default_value
            )
    ...
    def resolve_wildcards(self, param_name: str = "") -> list:
        ...
        for key in keys_in_portion:
            ...
            portions_path = f"{PATH_SEPARATOR_CHAR}{LIST_HORIZONTAL_RESOLVING_CHAR}{PATH_SEPARATOR_CHAR}"\
                .join(portions)
            if portions_path:
            ...
            if self._needs_resolving(path):
                ...
                # No more "#", then just return the value of the whole path only if the key exists
    ...
    def _get_horizontally(self, param_name: str = "", default_value: any = None) -> list:
        """
        Gets the values of all the possible paths horizontally across the defined lists iterations
    ...
    def _set_horizontally(self, param_name: str, value: any = None):
        """
        Sets the values of all the possible paths horizontally across the defined lists iterations
